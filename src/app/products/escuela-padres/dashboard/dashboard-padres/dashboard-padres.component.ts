...
@Component({
  selector: 'app-dashboard-padres',
  templateUrl: './dashboard-padres.component.html',
  styleUrls: ['./dashboard-padres.component.css']
})
export class DashboardPadresComponent implements OnInit, AfterViewInit {

  constructor(private renderer: Renderer2) { }

  ngOnInit(): void {
    // Cargar scripts externos aquí si es necesario
  }
