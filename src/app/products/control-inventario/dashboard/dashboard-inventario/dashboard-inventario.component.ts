...
export class DashboardInventarioComponent implements OnInit, AfterViewInit {
  username: string = '';
  ...
  ngOnInit(): void {
    this.route.queryParams.subscribe(params => {
      this.username = params['username'] || 'AdminInventario'; // Obtener el nombre de usuario de los parámetros
    });
  }
